...
var login = function (loginURL, loginData) { return function (dispatch) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, axios_1.default.post(loginURL, loginData).then(function (_a) {
                    var data = _a.data;
...
var logout = function () { return function (dispatch) {
    dispatch(basic_1.default.removeUser());
    dispatch(basic_1.default.removeToken());
}; };
var verify = function (verifyURL, accessToken) {
...
var refresh = function (refreshURL, refreshToken) {
...
var fetchUser = function (fetchUserURL, accessToken) {
    if (accessToken === void 0) { accessToken = undefined; }
    return function (dispatch, getState) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
...
exports.default = { login: login, logout: logout, verify: verify, refresh: refresh, fetchUser: fetchUser };
