...
var basic_2 = __importDefault(require("./basic"));
...
var createActions = function (_a) {
    ...
    return ({
        ...
        initializeStore: function (accessToken, refreshToken) { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, function (dispatch) {
                        dispatch(basic_2.default.setToken({ access: accessToken, refresh: refreshToken }));
                        try {
                            dispatch(thunk_2.default.verify(verifyURL, accessToken)).then(function () {
                                dispatch(thunk_2.default.fetchUser(fetchUserURL, accessToken));
                            });
                        }
                        catch (error) {
                            try {
                                dispatch(thunk_2.default.refresh(refreshURL, refreshToken)).then(function () {
                                    dispatch(thunk_2.default.fetchUser(fetchUserURL, accessToken));
                                });
                            }
                            catch (error) {
