...
var actions = {
    login: function (createURL, loginData) { return function (dispatch) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, axios_1.default.post(createURL, loginData).then(function (_a) {
                        var data = _a.data;
                        dispatch(exports.reduxActions.setToken(data));
...
exports.createActions = function (_a) {
    ...
    return ({
        login: function (loginData) { return actions.login(create, loginData); },
